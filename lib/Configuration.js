...
class Configuration extends ConfigNode {
  ...
  loadFile(file, ext) {
    ...
    try {
      ...
      if (str) {
        const o = parser(str);
        if (!(o && typeof o === 'object')) { // noinspection ExceptionCaughtLocallyJS
          throw new Error('Parser returned nothing. Input string format may be unexpected');
        }
        this.load(o);
      }
    } catch (e) /* istanbul ignore next */ {
      e.message = 'Can\t parse "' + file + '". ' + e.message;
      throw e;
    }
    return this;
  }
