...
module.exports = {
  ...
  'url': {
    parse: (v) => parseString(v),
    validate: (v) =>
        v == null || validator.isURL(v, {require_tld: false})
  },

  'ip': {
    parse: (v) => parseString(v),
    validate: (v) => v == null || validator.isIP(v)
  },
  ...
  'wnp': {
    parse: (v) => parseString(v),
    validate: (v) => v == null || isWindowsNamedPipe(v)
  },

  'email': {
    parse: (v) => parseString(v),
    validate: (v) => v == null || validator.isEmail(v)
  },

  'uuid': {
    parse: (v) => parseString(v),
    validate: (v) => v == null || validator.isUUID(v)
  },

  'uuid3': {
    parse: (v) => parseString(v),
    validate: (v) => v == null || validator.isUUID(v, 3)
  },

  'uuid4': {
    parse: (v) => parseString(v),
    validate: (v) => v == null || validator.isUUID(v, 4)
  },

  'uuid5': {
    parse: (v) => parseString(v),
    validate: (v) => v == null || validator.isUUID(v, 5)
  },

  'hex': {
    parse: (v) => parseString(v),
    validate: (v) => v == null || validator.isHexadecimal(v)
  },
